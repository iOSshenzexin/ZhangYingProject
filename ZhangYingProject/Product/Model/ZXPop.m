...
-(void)addPopWithView:(UIView *)mainView{
    ...
    windowView.tag = 103;
    CGFloat H = shadowView.bounds.size.height;
    windowView.frame = CGRectMake((ScreenW - 280) * 0.5, (H - 400) * 0.5, 280, 400);
    //[windowView.cancleBtn addTarget:self action:@selector(didClickCancleBtn:) forControlEvents:UIControlEventTouchUpInside];
